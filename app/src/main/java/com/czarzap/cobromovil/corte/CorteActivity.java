...
public class CorteActivity extends AppCompatActivity {
    ...
    CorteFragment.Callback mFragmentCallback = new CorteFragment.Callback() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivLaunchPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CorteFragment pickerFrag = new CorteFragment();
                ...
                if (!optionsPair.first) { // If options are not valid
                    Toast.makeText(CorteActivity.this, "No pickers activated",
    ...
    void dealWithSavedInstanceState(Bundle savedInstanceState) {
        if (savedInstanceState == null) { // Default
            ...
            // Set callback
            CorteFragment restoredFragment = (CorteFragment)
